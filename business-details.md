# Business Details — Theresa Frische (for Impressum & Privacy)

> **Note to builder:** All values below are final EXCEPT the two marked `⟨PENDING⟩`
> (postal address and VAT status). Render those two as the clearly-marked placeholder text
> shown, and **continue the build** — do NOT stop or ask for these two specific fields.
> Everything else is real and final.

## Identity
- **Full name:** Theresa Frische
- **Public title (use only this):** Systemic & Integrative Counsellor /
  Systemische & Integrative Beraterin
- **Entity type:** Sole proprietor / self-employed counselling (Beratung) practice
...
## Notes
- Contact email is currently a Gmail address; Theresa may move to a domain address later —
