...
export const faq2En: FaqCategory[] = [
  {
    id: "individuals",
    title: "For Individuals",
    items: [
      {
        q: "What challenges do you support individuals with?",
        a: "I support people navigating stress, overwhelm and burnout, life transitions, relationships, questions of identity and direction, the realities of international life, and personal growth. Many of my clients are high-functioning people who look like they have it all together but feel stretched thin underneath. Counselling gives you a calm, confidential space to slow down, make sense of what you are carrying, and move forward with more clarity.",
      },
      {
        q: "Can counselling help with burnout and overwhelm?",
        a: "Yes. Feeling constantly depleted, running on empty, or unable to switch off is something many capable people experience, and it is worth taking seriously. In counselling we gently explore what is draining you, what your overwhelm is telling you, and how to rebuild your energy and boundaries. The aim is to help you feel more grounded, resourced, and in tune with what matters to you.",
      },
      {
        q: "I'm high-functioning but exhausted — is this for me?",
        a: "Absolutely. Many people who come to me are successful and dependable on the outside while feeling tired, stretched, or disconnected within. You do not need to be in crisis to benefit from counselling. This is a space where you can set down the pressure to keep performing and focus on your own wellbeing for a change.",
      },
      {
        q: "Can counselling help with a major life transition?",
        a: "Yes. Big changes such as a new role, a move abroad, becoming a parent, the end of a relationship, or an uncertain next chapter can leave you feeling unsettled even when the change is a positive one. Counselling offers steady support while you find your footing and reconnect with your own direction. Together we make room to reflect, adjust, and step forward at a pace that feels right for you.",
      },
      {
        q: "Can counselling help me with identity and direction?",
        a: "Yes. Questions like who am I now, what do I really want, and where do I belong come up often, especially during transitions or after years of putting others first. Counselling gives you space to explore these questions honestly and without pressure. My aim is to help you reconnect with your own values and sense of direction so your choices feel more like your own.",
      },
      {
        q: "Can counselling help me manage stress?",
        a: "Yes. When stress builds up over time it can affect how you sleep, think, relate to others, and feel day to day. In counselling we look at what is fuelling your stress and explore practical, sustainable ways to steady yourself. Over time many clients find they feel calmer, clearer, and more able to respond to life rather than simply react to it.",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Both partners usually attend together, since much of the value comes from the conversation that unfolds between you. That said, it is completely fine for one partner to begin alone if the other is not ready yet or is unavailable for a session. Starting on your own can still bring helpful insight and often opens the door to working together later.",
      },
      {
        q: "What can couples counselling help with?",
        a: "Couples counselling can help with communication difficulties, emotional distance, recurring conflict, and rebuilding closeness and reconnection. It is also valuable during shared transitions such as relocation, new family stages, or navigating life across cultures and time zones. Whatever you are facing, the aim is to help you understand each other better and feel more like a team again.",
      },
      {
        q: "How long are couples sessions?",
        a: "Couples sessions usually run between 60 and 120 minutes, depending on what suits you and what you want to work on. The longer format can give a couple more room to explore a topic fully without feeling rushed. We can agree on the right length together, and it can be adjusted as we go.",
      },
      {
        q: "Can we attend from different countries or time zones?",
        a: "Yes. Because sessions take place online, the two of you can join from different locations or time zones and still meet together in the same virtual room. This works well for partners who travel, live apart for a time, or are relocating. I work across time zones by arrangement, based in Central European Time, so we can find a slot that works for you both.",
      },
      {
        q: "Is couples counselling only for relationships in crisis?",
        a: "No. Couples counselling is not only for relationships that are struggling. Many couples come to strengthen an already good relationship, deepen their connection, or navigate a shared transition together. It can be a caring, proactive way to invest in your relationship at any stage.",
      },
    ],
  },
  {
    id: "international",
    title: "International & Expat Life",
    items: [
      {
        q: "Do you work with expats and internationals?",
        a: "Yes. Supporting internationals and expats is at the heart of my work, and I offer sessions in both English and German. I understand the particular mix of opportunity and pressure that comes with building a life away from home. Whether you are newly arrived, long settled, or somewhere in between, you are very welcome here.",
      },
      {
        q: "Can we work together if I live in another country?",
        a: "Yes. All sessions take place online by video, so we can work together wherever you are in the world. I see clients internationally and work across time zones by arrangement, based in Central European Time. All you need is a private space and a stable connection.",
      },
      {
        q: "Do you understand the challenges of living between cultures?",
        a: "Yes. Living between cultures can bring a quiet sense of not fully belonging anywhere, alongside questions of identity, language, and home. Many internationals carry this experience without ever putting words to it. In counselling we can explore what living between worlds means for you and help you feel more settled and at home in yourself.",
      },
      {
        q: "Can you help with relocation stress?",
        a: "Yes. Relocating can be exciting and exhausting at the same time, bringing practical upheaval, loss of familiar support, and a lot of adjustment all at once. Counselling offers steady support while you find your footing in a new place. Together we can ease the overwhelm and help you reconnect with a sense of stability and direction.",
      },
      {
        q: "Do you work with cross-cultural couples?",
        a: "Yes. Cross-cultural couples often navigate differences in language, family expectations, and ideas of home, which can add richness as well as friction to a relationship. I work with couples in both English and German and can support you across different locations and time zones online. My aim is to help you understand each other more deeply and build a shared way of living that honours both of you.",
      },
    ],
  },
];

export const faq2De: FaqCategory[] = [
  {
    id: "individuals",
