...
export const existingEn: BlogPost[] = [
  {
    ...
    body: [
      ...
      { type: "p", text: "This is often where [working together in individual counselling](/work-with-me/psychological-counselling) can help — a steady, reflective space to slow down and listen to what has gone unnamed. Sometimes that means making sense of how the strain built up. Sometimes it means gently experimenting with new ways of responding — to your own needs, your relationships, and the pace of your life. The aim is not to make you function even better, but to help you feel more like yourself again." },
  ...
  },
  {
    ...
    body: [
      ...
      { type: "p", text: "This is often where [working together in counselling](/work-with-me) helps — a steady point of reference while everything else is shifting, a reflective space to make sense of what is being left behind, what is being asked of you, and what matters most as you move forward. Not to speed the transition up, but to help you move through it with more steadiness and self-understanding. If your particular change involves a move to a new country, you may also recognise yourself in this piece on [the stress of adjusting to a new country](/blog/relocation-stress-adjusting-new-country)." },
...
export const existingDe: BlogPost[] = [
  {
    ...
    body: [
      ...
      { type: "p", text: "Genau hier kann [die Einzelberatung](/de/angebot/psychologische-beratung) helfen — ein verlässlicher Raum zum Nachdenken, um zur Ruhe zu kommen und dem zuzuhören, was bisher unausgesprochen blieb. Manchmal geht es darum, zu verstehen, wie sich die Belastung aufgebaut hat. Manchmal darum, behutsam neue Wege auszuprobieren, mit den eigenen Bedürfnissen, den Beziehungen und dem Tempo des eigenen Lebens umzugehen. Das Ziel ist nicht, dass Sie noch besser funktionieren, sondern dass Sie sich wieder mehr wie Sie selbst fühlen." },
  ...
  },
  {
    ...
    body: [
      ...
      { type: "p", text: "In meiner Arbeit ist Somatic Experiencing eine Sichtweise unter mehreren. Ich greife darauf neben systemischen und achtsamkeitsbasierten Ansätzen zurück, je nachdem, was dem Menschen vor mir gerade guttut — wie eine [Zusammenarbeit](/de/angebot/somatic-experiencing) aussehen könnte, erfahren Sie, wenn Sie diese Arbeitsweise anspricht. Für manche ist die Aufmerksamkeit für den Körper das fehlende Stück; für andere ist sie ein Faden in einer umfassenderen Auseinandersetzung. Wenn Sie ein umfassenderes Bild davon möchten, wie diese Zustände wirken, passt meine [verständliche Einführung in das Nervensystem](/de/blog/nervous-system-plain-english-guide) eng dazu. Häufige Fragen dazu, wie Somatic Experiencing in den Sitzungen zum Einsatz kommt, beantworte ich in den [FAQ](/de/faq)." },
