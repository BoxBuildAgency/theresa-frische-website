...
export const existingDe: BlogPost[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { type: "p", text: "In meiner eigenen Arbeit ist Somatic Experiencing eine Perspektive unter mehreren. Ich schöpfe daraus neben systemischen und achtsamkeitsbasierten Ansätzen, je nachdem, was sich für den Menschen vor mir hilfreich anfühlt — mehr darüber, wie wir [zusammenarbeiten](/de/work-together) könnten, erfahren Sie, wenn Sie diese Arbeitsweise anspricht. Für manche Menschen ist die Aufmerksamkeit für den Körper das fehlende Stück; für andere ist sie ein Strang einer umfassenderen Erkundung. Wenn Sie ein umfassenderes Bild davon möchten, wie diese Zustände wirken, steht meine [verständliche Einführung in das Nervensystem](/de/blog/nervous-system-plain-english-guide) eng daneben. Häufige Fragen dazu, wie Somatic Experiencing in den Sitzungen genutzt wird, beantworte ich in den [FAQ](/de/faq)." },
  ...
  },
  {
    ...
    body: [
      ...
      { type: "p", text: "Genau hier hilft oft [die Zusammenarbeit in der Beratung](/de/work-together) — ein verlässlicher Bezugspunkt, während sich alles andere verschiebt, ein reflexiver Raum, um zu verstehen, was zurückgelassen wird, was von Ihnen verlangt wird und was am meisten zählt, während Sie sich vorwärtsbewegen. Nicht um den Übergang zu beschleunigen, sondern um Ihnen zu helfen, mit mehr Stabilität und Selbstverständnis hindurchzugehen. Wenn Ihre Veränderung einen Umzug in ein neues Land umfasst, erkennen Sie sich vielleicht auch in diesem Beitrag über [den Stress, sich in einem neuen Land einzugewöhnen](/de/blog/relocation-stress-adjusting-new-country), wieder." },
