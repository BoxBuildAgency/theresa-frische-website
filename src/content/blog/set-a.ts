...
export const setAEn: BlogPost[] = [
  {
    ...
    body: [
      {
        type: "p",
        text: "On paper, everything is working. You have the apartment, the job, the routine, perhaps the partner and the friends you meet for dinner. You have learned where to buy the good bread and how to complain about the weather like a local. And yet, somewhere underneath all of that competence, there is a quiet sense that you are still standing slightly outside your own life.",
      },
      {
        type: "p",
        text: "This is one of the most common experiences internationals bring into counselling, and one of the least talked about. Emotional loneliness in a new country is not the same as being alone. You can be surrounded by people and still feel that no one quite knows you, and that you no longer quite know yourself.",
      },
      {
        type: "h2",
        text: "Functioning well is not the same as feeling at home",
      },
      {
        type: "p",
        text: "Most high-functioning internationals are very good at building a life. You arrive, you organise, you adapt. Competence, though, can quietly become a mask. It is entirely possible to run a full, successful life abroad while feeling disconnected inside it. If that gap between how you function and how you feel sounds familiar, you might find it helpful to read more about [the difference between functioning well and feeling well](/blog/functioning-well-vs-feeling-well).",
      },
      {
        type: "p",
        text: "The loneliness that persists here is rarely about a lack of activity. It is about a lack of effortless belonging: the friendships that came without scheduling, the shared references, the sense that you could be understood without first explaining your whole context.",
      },
      {
        type: "h2",
        text: "The small daily disconnections",
      },
      {
        type: "p",
        text: "Emotional distance abroad tends to show up not in dramatic moments but in small, cumulative ones. A joke that lands differently. A form you cannot read. A conversation where you can follow every word and still miss the meaning underneath. Each is minor. Together, over months, they add up to a low-grade fatigue that many people cannot quite name.",
      },
      {
        type: "ul",
        items: [
          "Noticing you rehearse ordinary conversations in your head before you have them",
          "Feeling most yourself only when speaking your first language, which you now rarely do",
          "Sensing that your closest people back home no longer fully understand your daily life",
          "Being competent everywhere and comforted nowhere",
        ],
      },
      {
        type: "p",
        text: "Language and culture fatigue is real. Operating in a second language all day is quietly effortful, even when you are fluent. It uses energy that used to be free, and that spare capacity was often what you spent on connection.",
      },
      {
        type: "h2",
        text: "Rebuilding connection, slowly",
      },
      {
        type: "p",
        text: "The good news is that belonging can be rebuilt, though usually not by trying harder to socialise. It grows from smaller, more honest contact: relationships where you can be tired, unsure, or homesick without performing. It also grows from your relationship with yourself, and from restoring the everyday habits that keep you steady.",
      },
      {
        type: "p",
        text: "Practices that regulate your nervous system, rather than just fill your calendar, tend to help most. Simple, repeatable moments of grounding can make a new place feel less like a stage and more like a home. If you would like structured support with this, our [weekly wellbeing](/weekly-wellbeing) programme is built around exactly these gentle, sustainable rhythms.",
      },
      {
        type: "quote",
        text: "Belonging is not something you arrange. It is something you allow, one honest conversation at a time.",
        attribution: "Theresa Frische",
      },
      {
        type: "h2",
        text: "When it might be time for support",
      },
      {
        type: "p",
        text: "There is no threshold you have to reach before reaching out. But if the disconnection has become persistent, if it is dampening your mood, your sleep, or your sense of hope, it can help to talk it through with someone who understands the terrain. Counselling offers a space to make sense of the loneliness rather than pushing past it.",
      },
      {
        type: "p",
  ...
  },
  {
    ...
    title:
      "Growing Apart, Growing Together: Navigating Distance in Long-Term Relationships",
    ...
    body: [
      {
        type: "p",
        text: "Few couples drift apart on purpose. It happens gradually, in the spaces between busy weeks and shared logistics, until one day you look across the table and realise you are running a household together far more than you are actually meeting each other.",
      },
      {
        type: "p",
        text: "Emotional distance in a long-term relationship is common, and it is not, by itself, a sign that something is broken. It is often a sign that two people have kept growing, sometimes in different directions, without pausing to update how they know one another.",
      },
      {
        type: "h2",
        text: "How distance quietly builds",
      },
      {
        type: "p",
        text: "Distance rarely announces itself. It accumulates through small omissions: the conversations you no longer bother to start, the feelings you decide not to mention because it is late, the assumption that your partner already knows what you mean. Over time, these gaps harden into a kind of polite parallel living.",
      },
      {
        type: "ul",
        items: [
          "Conversations that stay on the surface of schedules and to-do lists",
          "Feeling more like efficient co-managers than close companions",
          "Avoiding certain topics because they seem to lead nowhere good",
          "A sense of missing each other even while in the same room",
        ],
      },
      {
        type: "p",
        text: "None of these mean the connection is gone. They mean it has gone quiet, and quiet things can be turned up again with attention.",
      },
      {
        type: "h2",
        text: "Growing apart and growing together are not opposites",
      },
      {
        type: "p",
        text: "It is a myth that healthy couples never change. People are supposed to evolve, and long relationships ask you to keep re-meeting a partner who is not the same person they were five years ago. Trouble arises less from the change itself and more from failing to make space for it, so that you end up in love with a memory rather than the person in front of you.",
      },
      {
        type: "p",
        text: "Reconnection, then, is partly an act of curiosity. It means becoming interested again in who your partner is now, and letting them get curious about who you have become.",
      },
      {
        type: "h2",
        text: "Practical first steps toward reconnection",
      },
      {
        type: "p",
        text: "You do not need a grand gesture to begin. Small, consistent turns toward each other tend to do more than a single dramatic conversation. A few starting points that many couples find useful:",
      },
      {
        type: "ul",
        items: [
          "Set aside short, protected time to talk with no phones and no logistics allowed",
          "Ask one genuinely open question a day, then listen without fixing",
          "Name what you appreciate out loud, even when it feels obvious",
          "Notice bids for connection, the small gestures that say pay attention to me, and answer them",
        ],
      },
      {
        type: "p",
        text: "If cultural or language differences are part of your story, the way you each express closeness may differ more than you realise. You might find our reflections on [love across cultures](/blog/love-across-cultures) a helpful companion piece.",
      },
      {
        type: "quote",
        text: "You do not have to be the same people you were to be close again. You only have to be willing to meet the people you have become.",
        attribution: "Theresa Frische",
      },
      {
        type: "h2",
        text: "When to seek support together",
      },
      {
        type: "p",
        text: "Sometimes the conversations you most need to have are the hardest to start on your own. A neutral, warm space can make it possible to say the things that keep getting stuck, and to hear each other without the usual defences. That is exactly what couples counselling offers.",
      },
      {
        type: "p",
  ...
  },
  {
    ...
    body: [
      {
        type: "p",
        text: "Loving someone from a different culture can feel like being handed a wider world. You gain new languages, new foods, new ways of celebrating, and a partner who lets you see your own assumptions from the outside. It can be one of the most expansive experiences a relationship offers.",
      },
      {
        type: "p",
        text: "It can also be quietly demanding in ways that surprise you. The very differences that enrich the relationship are the same ones that can leave you both feeling misunderstood, often about things neither of you thought to explain.",
      },
      {
        type: "h2",
        text: "The joys that are easy to underrate",
      },
      {
        type: "p",
        text: "Intercultural couples often develop an unusual capacity for curiosity. Because so little can be taken for granted, you learn to ask rather than assume, and that habit, once built, tends to make the whole relationship more conscious and more alive. Many couples describe a shared, private culture they have created together, belonging fully to neither background and entirely to them.",
      },
      {
        type: "h2",
        text: "Where the friction usually lives",
      },
      {
        type: "p",
        text: "Cultural difference rarely causes conflict over big, visible values. More often it hides in the ordinary: how directly you say what you mean, how you handle disagreement, what counts as affection, how much family should be involved, what silence signifies. Each of you learned these rules so early that they feel less like culture and more like simple fact.",
      },
      {
        type: "ul",
        items: [
          "Different instincts about whether to address tension head-on or let it settle",
          "Mismatched expectations about family closeness, holidays, and obligation",
          "Communication styles that read as too blunt or too indirect to the other",
          "Emotional expression that feels either overwhelming or withholding across the divide",
        ],
      },
      {
        type: "p",
        text: "When these differences collide, it is easy to conclude that your partner is being difficult, when in truth you are each following a script you never chose. Naming the script is often the first relief.",
      },
      {
        type: "h2",
        text: "Building shared understanding",
      },
      {
        type: "p",
        text: "The couples who thrive are not the ones with the fewest differences. They are the ones who regard difference as information rather than as a verdict. That means getting curious about the why behind a reaction instead of only reacting to the what.",
      },
      {
        type: "ul",
        items: [
          "Ask what a behaviour meant in your partner's family growing up, not just what it means to you",
          "Agree on a shared third way rather than defaulting to one culture's norms",
          "Translate feelings, not only words, when a phrase lands harder than intended",
          "Let there be things you do differently, on purpose, without needing to resolve them",
        ],
      },
      {
        type: "p",
        text: "If one or both of you is also living far from home, the relationship may be carrying extra weight. You might recognise some of this in our piece on [building a life abroad without feeling at home](/blog/built-a-life-abroad-not-at-home), which explores the loneliness that can quietly enter even a loving partnership.",
      },
      {
        type: "quote",
        text: "In an intercultural relationship, understanding is not something you inherit. It is something you build together, on purpose.",
        attribution: "Theresa Frische",
      },
      {
        type: "h2",
        text: "When support helps",
      },
      {
        type: "p",
        text: "There is real value in having someone help you translate between two inner worlds, especially when the same argument keeps returning in different clothes. Counselling can offer a calm space to slow down, understand each other's origins, and design the shared culture you actually want.",
      },
      {
        type: "p",
  ...
  },
  {
    ...
    title:
      "Mindfulness Isn't About Clearing Your Mind — Here's What It Actually Is",
    ...
    body: [
      {
        type: "p",
        text: "If you have ever tried to meditate, given up after ninety seconds, and concluded that your mind is simply too busy for this, you are in very good company. The belief that mindfulness means emptying your head is probably the single most common reason people decide they are bad at it.",
      },
      {
        type: "p",
        text: "The relief is this: mindfulness was never about clearing your mind. A mind that produces thoughts is a mind that is working correctly. The practice is not about stopping the thoughts. It is about changing your relationship to them.",
      },
      {
        type: "h2",
        text: "The myths worth letting go of",
      },
      {
        type: "p",
        text: "A handful of misunderstandings keep people from a practice that could genuinely help them. It is worth naming them plainly.",
      },
      {
        type: "ul",
        items: [
          "Myth: your mind should go blank. In reality, you simply notice when it wanders and gently return.",
          "Myth: you must feel calm and blissful. In reality, you are learning to be present with whatever is here, including restlessness.",
          "Myth: it takes an hour a day. In reality, a few honest minutes, done regularly, do more than an occasional long session.",
          "Myth: you are doing it wrong if you get distracted. In reality, noticing the distraction is the practice.",
        ],
      },
      {
        type: "h2",
        text: "So what is it, actually?",
      },
      {
        type: "p",
        text: "Mindfulness is the simple, repeatable act of paying attention to the present moment without immediately judging it. You notice a thought, a sensation, a feeling. You let it be there. You come back to your breath or your body. You do this again, and again, and each return is a small rep that strengthens your capacity to stay with your own experience.",
      },
      {
        type: "p",
        text: "That is the whole thing. It is far less mystical than it sounds and far more useful than it seems.",
      },
      {
        type: "h2",
        text: "How it supports emotional regulation",
      },
      {
        type: "p",
        text: "The everyday payoff is a bit more space between what happens and how you respond. When you can notice a wave of stress or frustration as it rises, rather than being swept off by it, you gain a moment of choice you did not have before. Over time, that small pause reshapes how you move through difficult days.",
      },
      {
        type: "ul",
        items: [
          "You catch tension in the body earlier, before it becomes overwhelm",
          "You respond to stress with a little more room and a little less reactivity",
          "You steady low mood by staying with it kindly instead of fighting it",
          "You recover your footing faster after a hard moment",
        ],
      },
      {
        type: "quote",
        text: "The goal is not a quiet mind. The goal is a friendlier relationship with the mind you already have.",
        attribution: "Theresa Frische",
      },
      {
        type: "h2",
        text: "Starting small and staying with it",
      },
      {
        type: "p",
      ...
      {
        type: "p",
        text: "If you would like a supported, gentle way to build this into your life, our [weekly wellbeing](/weekly-wellbeing) programme offers exactly that kind of regular, unhurried rhythm. And if you are curious to go deeper into the body-based side of presence, you may enjoy our reflections on [what somatic experiencing is](/blog/what-is-somatic-experiencing). Whichever way you start, remember that a wandering mind is not a failure. It is simply your invitation to begin again.",
      },
    ],
  },
];

export const setADe: BlogPost[] = [
  {
    slug: "built-a-life-abroad-not-at-home",
    title:
    ...
    body: [
      ...
      {
        type: "h2",
        text: "Verbindung langsam wieder aufbauen",
      },
      {
        type: "p",
      ...
      {
        type: "h2",
        text: "Wann Unterstützung sinnvoll sein kann",
      },
      {
        type: "p",
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: "h2",
        text: "Wann gemeinsame Unterstützung sinnvoll ist",
      },
      {
        type: "p",
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: "h2",
        text: "Ein gemeinsames Verständnis aufbauen",
      },
      {
        type: "p",
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: "h2",
        text: "Klein anfangen und dranbleiben",
      },
      {
        type: "p",
